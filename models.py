...
class A_mobileNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.conv8 = nn.Conv2d(128, 128, kernel_size=3, stride=2, padding=1, groups=128)
        self.bn8 = nn.BatchNorm2d(128)
        self.conv9 = nn.Conv2d(128, 256, kernel_size=1, stride=1, padding=0)
        self.bn9 = nn.BatchNorm2d(256)
        self.relu9 = nn.ReLU6(inplace=True)

        self.cbam1 = CBAM(256)

        self.conv10 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1, groups=256)
        self.bn10 = nn.BatchNorm2d(256)
        self.conv11 = nn.Conv2d(256, 256, kernel_size=1, stride=1, padding=0)
        self.bn11 = nn.BatchNorm2d(256)
        self.relu11 = nn.ReLU6(inplace=True)

        self.conv12 = nn.Conv2d(256, 256, kernel_size=3, stride=2, padding=1, groups=256)
        self.bn12 = nn.BatchNorm2d(256)
        self.relu12 = nn.ReLU6(inplace=True)
        self.conv13 = nn.Conv2d(256, 512, kernel_size=1, stride=1, padding=0)
        self.bn13 = nn.BatchNorm2d(512)
        self.relu13 = nn.ReLU6(inplace=True)

        self.cbam2 = CBAM(512)

        self.conv_loop1=nn.Sequential(
        ...
        self.conv14 = nn.Conv2d(512, 512, kernel_size=3, stride=2, padding=1, groups=512)
        self.bn14 = nn.BatchNorm2d(512)
        self.conv15 = nn.Conv2d(512, 1024, kernel_size=1, stride=1, padding=0)
        self.bn15 = nn.BatchNorm2d(1024)
        self.relu15 = nn.ReLU6(inplace=True)

        self.conv16 = nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1, groups=1024)
        self.bn16 = nn.BatchNorm2d(1024)
        self.conv17 = nn.Conv2d(1024, 1024, kernel_size=1, stride=1, padding=0)
